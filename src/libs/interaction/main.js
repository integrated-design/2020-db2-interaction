    ...
    var VideoContainer = (function (_super) {
        ...
        function VideoContainer(filePaths) {
            ...
            _this.videoLoadSuccessHandler = function (event) {
                _this.dispatchEventType('loadSuccess', _this, event.getData());
            ...
            _this.videoLoadErrorHandler = function (event) {
                _this.dispatchEventType('loadError', _this, event.getData());
            };
            _this.videoLoopHandler = function (event) {
                _this.dispatchEventType('loop', _this, event.getData());
            };
    ...
    var Application = (function () {
        function Application(type, filePaths) {
            ...
            this.videoLoadSuccessHandler = function (event) {
                _this.loading.appendMessage('load success : ' + _this.filePaths[event.getData()]);
            };
            this.videoLoadErrorHandler = function (event) {
                _this.loading.appendMessage('load error : ' + _this.filePaths[event.getData()]);
            };
...
(function (project) {
    var TouchPlayReleaseStop = (function (_super) {
        ...
        function TouchPlayReleaseStop() {
            return _super.call(this, 'Touch Play & Release Stop', ['data/a.mp4']) || this;
        }
...
(function (project) {
    var TouchBReleaseARewind = (function (_super) {
        ...
        function TouchBReleaseARewind() {
            return _super.call(this, 'Touch B & Release A - Rewind', ['data/a.mp4', 'data/b.mp4']) || this;
        }
...
(function (project) {
    var TouchBReleaseASync = (function (_super) {
        ...
        function TouchBReleaseASync() {
            return _super.call(this, 'Touch B & Release A - Sync', ['data/a.mp4', 'data/b.mp4']) || this;
        }
